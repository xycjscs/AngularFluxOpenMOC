...
/**
 * @brief Returns the SinTheta for a given azimuthal angle index polar angle index.
 * @param the azimuthal angle index and polar angle index.
 * @return the desired SinTheta.
 */
double TrackGenerator::getSinTheta(int azim, int polar) {

  return _quadrature->getSinTheta(azim, polar);
}

int TrackGenerator::getNumPolarAngles() {

  return _quadrature->getNumPolarAngles();
}										 
